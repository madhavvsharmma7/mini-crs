...
```bash
# Run with built-in demo (3 vulnerabilities)
python main.py scan --demo

# Scan your own file
python main.py scan --file path/to/your/code.py

# Scan inline code
python main.py scan --code "import os; os.system(input())"

# Save JSON report
python main.py scan --demo --output report.json
```
...
- **Python 3.10+**
- **Claude API** (claude-sonnet-4-6) — LLM orchestration
- **Rich** — terminal UI
- **Typer** — CLI framework
